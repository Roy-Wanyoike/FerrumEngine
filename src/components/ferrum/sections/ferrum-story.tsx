...
const timeline: Era[] = [
  ...
  },
  {
    ...
    milestone: "FerrumEngine v1 — 848 effects, 11 categories",
  },
  {
    year: "2026",
  ...
  return (
    <div className="min-h-screen pt-20 pb-20">
      <div className="max-w-4xl mx-auto px-6 sm:px-8">
        {/* Header */}
        <Reveal>
          <p className="ferrum-section-label text-xs font-semibold uppercase tracking-[0.15em] text-purple-400/70 mb-4">Origin Story</p>
        </Reveal>
        <Reveal delay={0.05}>
        ...
        <Reveal delay={0.1}>
          <p className="text-lg text-muted-foreground/60 max-w-2xl leading-relaxed mt-5">
            Ferrum didn't start with a feature list. It started with a question:
            why, in 2025, do frontend developers still spend weeks building
        ...
        <div className="mt-20 relative">
          ...
          <div className="space-y-12">
            {timeline.map((era, i) => {
              ...
              return (
                <Reveal key={era.year} delay={i * 0.04}>
