    ...
    <div className="min-h-screen pt-20 pb-20">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <SectionHeader
          ...
          subtitle="A technical philosophy explaining the trajectory of interface engineering and why Ferrum exists at this particular moment in time."
          icon={Sparkles}
          maxWidth="4xl"
        />
        ...
        <div className="animate-in fade-in-0 slide-in-from-bottom-3" style={{ animationDelay: "0.15s", animationFillMode: "both" }}>
          <div className="mt-16 p-6 sm:p-8 rounded-2xl border border-border/40 bg-foreground/[0.01]">
            <h2 className="text-sm font-semibold text-foreground mb-6">The Trajectory</h2>
        ...
        <div className="mt-16 space-y-6">
          {manifesto.map((section, i) => {
            ...
            return (
              <div key={section.heading} className="animate-in fade-in-0 slide-in-from-bottom-3" style={{ animationDelay: `${i * 0.04}s`, animationFillMode: "both" }}>
