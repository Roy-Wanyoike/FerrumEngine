...
const archLayers = [
  { label: "Framework Adapters", desc: "React · Vue · Svelte · Angular · Next.js · Nuxt · Astro · Vanilla · Solid", color: "text-cyan-400", borderColor: "border-cyan-500/20", bgColor: "bg-cyan-500/[0.06]" },
  { label: "Ferrum Runtime", desc: "Core execution · Progressive enhancement · Hot-swap", color: "text-purple-400", borderColor: "border-purple-500/20", bgColor: "bg-purple-500/[0.06]" },
  { label: "Motion Engine", desc: "Spring physics · Scroll-driven · Gesture · Timeline", color: "text-violet-400", borderColor: "border-violet-500/20", bgColor: "bg-violet-500/[0.06]" },
  { label: "VFX Engine", desc: "Glass · Liquid · Particles · Distortion · Houdini Worklets", color: "text-pink-400", borderColor: "border-pink-500/20", bgColor: "bg-pink-500/[0.06]" },
  { label: "Component System", desc: "16 Semantic Primitives · ARIA · Theme-aware", color: "text-rose-400", borderColor: "border-rose-500/20", bgColor: "bg-rose-500/[0.06]" },
  { label: "Design Tokens", desc: "16 Scales · 5 Output Formats · Runtime Theming", color: "text-amber-400", borderColor: "border-amber-500/20", bgColor: "bg-amber-500/[0.06]" },
  { label: "Compiler Pipeline", desc: "Parse → Analyze → Optimize → Tree-shake → Output", color: "text-emerald-400", borderColor: "border-emerald-500/20", bgColor: "bg-emerald-500/[0.06]" },
];
          ...
          <div>
            ...
            <div className="animate-in fade-in-0 slide-in-from-bottom-3" style={{ animationDelay: "0.05s", animationFillMode: "both" }}>
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight">
                Built like an engine.<br /><span className="text-muted-foreground/50">Not a library.</span>
              </h2>
            </div>
            <div className="animate-in fade-in-0 slide-in-from-bottom-3" style={{ animationDelay: "0.1s", animationFillMode: "both" }}>
              <p className="text-lg text-muted-foreground/60 max-w-xl leading-relaxed mt-5">
                Every layer of Ferrum is designed for independence and composition. Framework
                adapters sit on top of a zero-dependency runtime. The motion engine, VFX engine,
                and component system communicate through a shared token layer. The compiler
                optimizes everything before it ships.
              </p>
            </div>
            <div className="animate-in fade-in-0 slide-in-from-bottom-3" style={{ animationDelay: "0.15s", animationFillMode: "both" }}>
              <div className="mt-8 space-y-4">
                {[
                  { icon: Layers, title: "Layered independence", desc: "Each subsystem works alone. Together, they're exponential." },
                  { icon: Workflow, title: "Shared token layer", desc: "Motion, VFX, and components speak the same design language." },
                  { icon: Cpu, title: "9-pass compilation", desc: "Parse, analyze, optimize, tree-shake, and output — automatically." },
