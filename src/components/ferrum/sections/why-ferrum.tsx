...
const problems: Problem[] = [
  ...
  {
    icon: AlertTriangle,
    title: "The 848-effect problem",
    description: "Ferrum already ships 848 CSS effects, 11 categories, and 20+ packages. Without a coherent architecture, it's just a large collection. Size without structure is noise, not a platform.",
  },
];
