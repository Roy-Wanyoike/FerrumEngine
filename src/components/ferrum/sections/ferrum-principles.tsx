  ...
  return (
    <section id="principles" className="py-28 sm:py-36 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <Reveal delay={0.05}>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground tracking-tight max-w-4xl">
            The Ferrum Principles
          </h2>
        </Reveal>
        <Reveal delay={0.1}>
          <p className="text-lg text-muted-foreground/60 max-w-2xl leading-relaxed mt-5">
            React has principles. Apple has Human Interface Guidelines. Google has Material Design.
            Stripe has engineering principles. Ferrum needs its own philosophy — a lens through which
            every feature, API, and design decision is evaluated.
          </p>
        </Reveal>
        ...
        <div className="mt-16 space-y-4">
          {principles.map((p, i) => {
            const Icon = p.icon;
            return (
              <Reveal key={p.number} delay={i * 0.04}>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="inline-flex items-start gap-2 px-3 py-2 rounded-lg bg-purple-500/[0.03] border border-purple-500/10">
                        <span className="text-[10px] font-semibold uppercase tracking-wider text-purple-400/70 shrink-0 pt-0.5">In practice</span>
