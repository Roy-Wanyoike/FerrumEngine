...
import { Sparkles, Zap, Eye, Layers, MousePointer } from "lucide-react";
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <StaggerContainer className="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-5" delay={0.1}>
          {wowDemos.map((demo) => {
            ...
            const colors = (spotlightMap as Record<string, {spotlight: string; glow: string}>)[demo.color] ?? {spotlight: 'rgba(161,161,170,0.04)', glow: 'rgba(161,161,170,0.10)'};
            return (
