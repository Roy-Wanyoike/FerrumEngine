...
import {
  Cpu, Zap, Terminal, Palette, Sparkles,
...
const subsystems: Subsystem[] = [
  ...
  },
  {
    ...
    futureRoadmap: ["AI-powered palette suggestion", "Figma plugin sync", "Token governance audit logs", "Brand compliance reports"],
  },
  {
    id: "compiler",
    ...
    problemSolved: "Unoptimized CSS is the #1 cause of large bundle sizes and slow render times. The Compiler ensures that Ferrum's 366+ effects produce the smallest possible output by only shipping what you actually use.",
...
export function ArchitectureBook({ onNavigate: _onNavigate }: { onNavigate: (view: string) => void }) {
