...
import {
  ...
  ArrowRight, Layers, GitBranch, Package, Shield, Blocks,
  ...
  return (
    <div className="space-y-2">
      {nodes.map((node) => {
        ...
        const st = statusBadge[node.status];
        return (
          <button
            key={node.id}
...
function DataFlowDiagram() {
  const steps = [
    { label: "Developer writes intent", icon: Wrench, desc: "rc-float, rc-glow, spring()" },
  ...
  return (
    <Reveal delay={0.2}>
      <div className="mt-16 p-6 sm:p-8 rounded-2xl border border-border/40 bg-foreground/[0.01]">
        <h3 className="text-lg font-bold text-foreground mb-2">Data Flow Pipeline</h3>
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        ...
        <Reveal delay={0.1}>
          <p className="text-lg text-muted-foreground/80 max-w-2xl leading-relaxed mt-5">
            Ferrum is not a single library. It is an integrated platform of 10 subsystems,
            each independently useful but exponentially more powerful together. Click any
            subsystem to explore its connections.
          </p>
        </Reveal>
        ...
        <div className="mt-16 grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Reveal delay={0.1}>
              <h3 className="text-sm font-semibold text-foreground mb-4">Subsystem Dependencies</h3>
          ...
          <div className="lg:col-span-3">
            <Reveal delay={0.15}>
              {selected ? (
                <AnimatedCard
                  spotlightColor={`${colorStyles[selected.color]?.bg || "bg-purple-500/10"}`}
                  ...
                  <div className="relative z-20 p-8">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selected.connections.map((connId) => {
                        ...
                        const cs = colorStyles[conn.color];
                        return (
                          <button
                            key={connId}
        ...
        <Reveal delay={0.1}>
          <div className="mt-16">
            <h3 className="text-lg font-bold text-foreground mb-2">Framework Adapters</h3>
            <p className="text-sm text-muted-foreground/70 mb-6">First-class integration with 9 frontend frameworks.</p>
            <IntegrationMatrix />
          </div>
        </Reveal>
        ...
        <Reveal delay={0.1}>
          <div className="mt-16 p-6 sm:p-8 rounded-2xl border border-purple-500/15 bg-purple-500/[0.03]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-foreground mb-2">Design Philosophy</h3>
